...
con.set_export_files("./masterthesis/nellResults/TransE/trueFalseV3correct/model.vec.tf", 0)
#Model parameters will be exported to json files automatically.
con.set_out_files("./masterthesis/nellResults/TransE/trueFalseV3correct/embedding.vec.json")
