...
con.set_import_files("./masterthesis/dbpediaResultsSampleNew/TransE/corruptFalse/model.vec.tf")
con.init()
...
#227189 233532 83
con.predict_head_entity(233532, 83, 10)
con.predict_tail_entity(227189, 83, 10)
con.predict_relation(227189, 233532, 10)
