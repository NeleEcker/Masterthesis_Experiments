...
con.set_import_files("./masterthesis/nellResults/TransD/trueFalse/model.vec.tf")
con.init()
...
#227189 233532 83
con.predict_head_entity(21070, 151, 10)
con.predict_tail_entity(20563, 151, 10)
con.predict_relation(20563, 21070, 10)
